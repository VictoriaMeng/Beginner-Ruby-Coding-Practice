...
=begin
Exercise 02: What will the following two programs return? What is value of arr after each?
...
"Answer: Arrays are indexed with integers, not strings like 'margaret'. To change the value array value 'margaret' to 'jody', use this code:" 
  names[3] = 'jody'
